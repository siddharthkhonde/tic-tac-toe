...
//took out wasm from beginning of github import

func main() {
	wasmBytes, _ := ioutil.ReadFile("./tictactoe.wasm")

	//creates an engine
	//responsible for driving compilation and execution of wasm mod
	//changed wasm.NewEngine to wasmer.NewEngine
	engine := wasm.NewEngine()
	//creates a store that holds the engine
	//changed wasm.NewStore to wasmer.NewStore
